...
<table class="table table-hover">
  ...
  <?php foreach($subMenu as $sm) : ?>
    <tr>
      ...
      <td><?= $sm['is_active']; ?></td>
      <td>
      <a href="#" data-toggle="modal" data-target="#modalEdit<?= $sm['id']; ?>" 
      class="badge badge-info" data-popup="tooltip" data-placement="top" 
      title="Edit Data"><i class="fa fa-fw fa-pencil-alt"></i></a>
      <a href="<?= base_url('menu/deleteSubMenu/') ?><?= $sm['id']; ?>" 
      class="badge badge-danger tombol" id="deleteSubMenu" name="deleteSubMenu">
...
<!-- Modal -->
<div class="modal fade" id="newSubMenuModal" tabindex="-1" 
role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modalEdit<?= $row['id'] ?>">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" readonly value="<?=$row['id'];?>" name="submenu_id" class="form_control">

      <div class="modal-body">
      <div class="form-group">
            <input type="text" class="form-control" id="title" 
            name="title" placeholder="Submenu title" value="<?=$row['title'];?>">
         </div>
        <div class ="form-group">
        <select name="menu_id" id="menu_id" class="form-control">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="url" 
            name="url" placeholder="Submenu url" value="<?=$row['url'];?>">
         </div>
        <div class="form-group">
            <input type="text" class="form-control" id="icon" 
            name="icon" placeholder="Submenu icon" value="<?=$row['icon'];?>">
         </div>
         <div class="form-group">
         <div class="form-check">
                <input class="form-check-input" type="checkbox" 
