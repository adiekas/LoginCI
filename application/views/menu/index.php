...
<table class="table table-hover">
  ...
  <?php foreach($menu as $m) : ?>
    <tr>
      ...
      <td><?= $m['menu']; ?></td>
      <td>
      <a href="#" data-toggle="modal" data-target="#modalEdit<?= $m['id']; ?>" 
      ...
      class="badge badge-danger tombol" id="delete" name="delete">
...
role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modalEdit<?= $row['id'] ?>"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" readonly value="<?=$row['id'];?>" name="menu_id" class="form_control">

      <div class="modal-body">
      <div class="form-group">
            <input type="text" class="form-control" id="menu" 
            name="menu" placeholder="Menu name" value="<?=$row['menu'];?>">
         </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" 
