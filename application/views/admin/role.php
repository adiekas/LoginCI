...
<table class="table table-hover">
  ...
  <?php foreach($role as $r) : ?>
    <tr>
      ...
      <a href="#" data-toggle="modal" data-target="#modalEdit<?= $r['id'];?>" class="badge badge-info" 
      data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fa fa-fw fa-pencil-alt"></i></a>
      <a href="<?= base_url('admin/delete/')?><?= $r['id'];?>" class="badge badge-danger tombol"
      id="delete" name="delete"><i class="fas fa-fw fa-trash-alt"></i></a>
      </td>
    </tr>
    <?php $i++; ?>
   <?php endforeach; ?>
...
role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modalEdit<?= $row['id'] ?>">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
            <input type="text" class="form-control" id="role" 
            name="role" placeholder="Role name" value="<?=$row['role'];?>">
         </div>
        </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" 
